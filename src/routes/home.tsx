    ...
    <>
        ...
        {isMobile ? (
          ...
          <>
            <GoabPageBlock width="1200px">
              <GoabBlock gap="2xl" direction={isTablet ? "column" : "row"} alignment={isTablet ? "left" : "center"}>
      ...
      <GoabOneColumnLayout>
        <section className="ds-main-content">
          <GoabPageBlock width="1200px">
            <GoabBlock gap="2xl" mt="4xl" mb="4xl" direction={isTablet ? "column" : "row"} alignment={isTablet ? "left" : "center"}>
              <div style={{ flex: 1 }}>
                <GoabText size="heading-l" mt="none">Build your service using the design system</GoabText>
              ...
              <div className="card-image" style={{ flex: 2.5 }}>
                <img src="/images/home/splash-reel.png"></img>
              </div>
            </GoabBlock>
            <GoabText size="heading-xl">Select your service pattern</GoabText>
            <GoabGrid gap="xl" mt="xl" mb="4xl" alignment="center" minChildWidth="320px">
              <CardLite
            ...
            <GoabGrid gap="xl" mt="xl" mb="4xl" alignment="center" minChildWidth="250px">
              <CardLite
            ...
            <GoabGrid gap="xl" mt="xl" mb="4xl" alignment="center" minChildWidth="260px">
              <CardLite
                imageURL="/images/home/primary-users-thumb.png"
