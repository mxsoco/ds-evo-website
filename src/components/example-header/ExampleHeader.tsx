import { GoabBlock, GoabButton, GoabText, GoabBadge, GoabIcon } from "@abgov/react-components";
    ...
    <div className="component-header">
      ...
      <GoabBlock gap="none" direction="column" alignment="start" width="100%">
        ...
        {(githubLink || figmaLink) && (
          ...
          <GoabBlock gap="l" direction="row" mt="xl" mb="xl">
            {githubLink && (
              <GoabBlock gap="2xs" direction="row">
                <GoabButton
                  ...
                  aria-label={`Open GitHub issue for ${name}`}
                  aria-describedby="Opens in a new tab"
                >
                  Github issue
                </GoabButton>
              </GoabBlock>
