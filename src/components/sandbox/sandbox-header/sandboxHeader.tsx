import { GoabIcon, GoabTooltip } from "@abgov/react-components";
    ...
    <div className="sandbox-header">
      ...
      <div className="header-container">
        ...
        <div className="heading-group">
          <h2 id={anchorId} ref={headingRef} style={{ marginBottom: "0", marginTop: "var(--goa-space-xl)", font: "var(--goa-typography-mobile-heading-m)" }}>
            {props.exampleTitle}
          </h2>
            ...
            <a href={props.figmaExample} className="icon-link no-external-icon" target="_blank"
              ...
              <svg className="icon-default" width="18" height="18" viewBox="0 0 24 24" fill="none"
                ...
                <path
                  ...
                  stroke="var(--goa-color-text-secondary)" strokeWidth="1.28947" />
                <path
